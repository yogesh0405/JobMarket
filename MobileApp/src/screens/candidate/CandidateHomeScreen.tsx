...
export const CandidateHomeScreen: React.FC<Props> = ({ navigation }) => {
  ...
  // Top Search Bar Rotating Placeholders State
  const SEARCH_PLACEHOLDERS = [
    'Search Jobs, Roles, Skills...',
    'Search CNC, VMC, Fitter...',
    'Search Waluj, Chakan MIDC...',
    'Search Companies & Factories...',
  ];
  ...
  return (
    <View style={styles.container}>
      <Header
        searchPlaceholder={SEARCH_PLACEHOLDERS[placeholderIndex] || 'Search Jobs, Skills, Companies, MIDCs...'}
        onSearchPress={() => {
          navigation.navigate('CandidateGlobalSearch');
        }}
        showBack={false}
      />
